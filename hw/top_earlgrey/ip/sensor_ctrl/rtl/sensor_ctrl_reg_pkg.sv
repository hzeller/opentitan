...
package sensor_ctrl_reg_pkg;
  ...
  ////////////////////////////
  typedef struct packed {logic q;} sensor_ctrl_reg2hw_ack_mode_mreg_t;

  typedef struct packed {logic q;} sensor_ctrl_reg2hw_alert_trig_mreg_t;
  ...
  // Register Address
  parameter logic [4:0] SENSOR_CTRL_CFG_REGWEN_OFFSET = 5'h0;
  parameter logic [4:0] SENSOR_CTRL_ACK_MODE_OFFSET = 5'h4;
  parameter logic [4:0] SENSOR_CTRL_ALERT_TRIG_OFFSET = 5'h8;
  parameter logic [4:0] SENSOR_CTRL_ALERT_STATE_OFFSET = 5'hc;
  parameter logic [4:0] SENSOR_CTRL_STATUS_OFFSET = 5'h10;
