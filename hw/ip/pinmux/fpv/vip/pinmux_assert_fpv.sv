...
module pinmux_assert_fpv (
  ...
  `ASSERT(OutSel0_A, mio_outsel.q == 0 |-> mio_out_o[mio_sel_i] == 1'b0)
  `ASSERT(OutSel1_A, mio_outsel.q == 1 |-> mio_out_o[mio_sel_i] == 1'b1)
  `ASSERT(OutSel2_A, mio_outsel.q == 2 |-> mio_out_o[mio_sel_i] == 1'b0)
  ...
  `ASSERT(OutSelOe0_A, mio_outsel.q == 0 |-> mio_oe_o[mio_sel_i] == 1'b1)
  `ASSERT(OutSelOe1_A, mio_outsel.q == 1 |-> mio_oe_o[mio_sel_i] == 1'b1)
  `ASSERT(OutSelOe2_A, mio_outsel.q == 2 |-> mio_oe_o[mio_sel_i] == 1'b0)
