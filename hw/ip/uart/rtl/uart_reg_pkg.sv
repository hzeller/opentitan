...
package uart_reg_pkg;
  ...
  typedef struct packed {logic [7:0] d;} uart_hw2reg_rdata_reg_t;
  ...
  typedef struct packed {logic [15:0] d;} uart_hw2reg_val_reg_t;
  ...
  // Register Address
  parameter logic [5:0] UART_INTR_STATE_OFFSET = 6'h0;
  parameter logic [5:0] UART_INTR_ENABLE_OFFSET = 6'h4;
  parameter logic [5:0] UART_INTR_TEST_OFFSET = 6'h8;
  parameter logic [5:0] UART_CTRL_OFFSET = 6'hc;
  parameter logic [5:0] UART_STATUS_OFFSET = 6'h10;
  parameter logic [5:0] UART_RDATA_OFFSET = 6'h14;
  parameter logic [5:0] UART_WDATA_OFFSET = 6'h18;
  parameter logic [5:0] UART_FIFO_CTRL_OFFSET = 6'h1c;
  parameter logic [5:0] UART_FIFO_STATUS_OFFSET = 6'h20;
  parameter logic [5:0] UART_OVRD_OFFSET = 6'h24;
  parameter logic [5:0] UART_VAL_OFFSET = 6'h28;
  parameter logic [5:0] UART_TIMEOUT_CTRL_OFFSET = 6'h2c;
