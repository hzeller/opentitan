...
package usbuart_reg_pkg;
  ...
  typedef struct packed {
    ...
    struct packed {logic q;} tx_overflow;
  ...
  typedef struct packed {logic [7:0] d;} usbuart_hw2reg_rdata_reg_t;
  ...
  typedef struct packed {logic [15:0] d;} usbuart_hw2reg_val_reg_t;

  typedef struct packed {
    struct packed {logic [10:0] d;} frame;
    struct packed {logic d;} host_timeout;
    struct packed {logic d;} host_lost;
    struct packed {logic [6:0] d;} device_address;
  } usbuart_hw2reg_usbstat_reg_t;

  typedef struct packed {
    struct packed {logic [15:0] d;} baud_req;
    struct packed {logic [1:0] d;} parity_req;
  ...
  // Register Address
  parameter logic [5:0] USBUART_INTR_STATE_OFFSET = 6'h0;
  parameter logic [5:0] USBUART_INTR_ENABLE_OFFSET = 6'h4;
  parameter logic [5:0] USBUART_INTR_TEST_OFFSET = 6'h8;
  parameter logic [5:0] USBUART_CTRL_OFFSET = 6'hc;
  parameter logic [5:0] USBUART_STATUS_OFFSET = 6'h10;
  parameter logic [5:0] USBUART_RDATA_OFFSET = 6'h14;
  parameter logic [5:0] USBUART_WDATA_OFFSET = 6'h18;
  parameter logic [5:0] USBUART_FIFO_CTRL_OFFSET = 6'h1c;
  parameter logic [5:0] USBUART_FIFO_STATUS_OFFSET = 6'h20;
  parameter logic [5:0] USBUART_OVRD_OFFSET = 6'h24;
  parameter logic [5:0] USBUART_VAL_OFFSET = 6'h28;
  parameter logic [5:0] USBUART_TIMEOUT_CTRL_OFFSET = 6'h2c;
  parameter logic [5:0] USBUART_USBSTAT_OFFSET = 6'h30;
  parameter logic [5:0] USBUART_USBPARAM_OFFSET = 6'h34;
