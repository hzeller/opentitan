...
package gpio_reg_pkg;
  ...
  ////////////////////////////
  typedef struct packed {logic [31:0] q;} gpio_reg2hw_intr_state_reg_t;

  typedef struct packed {logic [31:0] q;} gpio_reg2hw_intr_enable_reg_t;
  ...
  typedef struct packed {logic [31:0] q;} gpio_reg2hw_intr_ctrl_en_rising_reg_t;

  typedef struct packed {logic [31:0] q;} gpio_reg2hw_intr_ctrl_en_falling_reg_t;

  typedef struct packed {logic [31:0] q;} gpio_reg2hw_intr_ctrl_en_lvlhigh_reg_t;

  typedef struct packed {logic [31:0] q;} gpio_reg2hw_intr_ctrl_en_lvllow_reg_t;

  typedef struct packed {logic [31:0] q;} gpio_reg2hw_ctrl_en_input_filter_reg_t;
  ...
  typedef struct packed {logic [31:0] d;} gpio_hw2reg_direct_out_reg_t;

  typedef struct packed {
    struct packed {logic [15:0] d;} data;
    struct packed {logic [15:0] d;} mask;
  ...
  typedef struct packed {logic [31:0] d;} gpio_hw2reg_direct_oe_reg_t;
  ...
  // Register Address
  parameter logic [5:0] GPIO_INTR_STATE_OFFSET = 6'h0;
  parameter logic [5:0] GPIO_INTR_ENABLE_OFFSET = 6'h4;
  parameter logic [5:0] GPIO_INTR_TEST_OFFSET = 6'h8;
  parameter logic [5:0] GPIO_DATA_IN_OFFSET = 6'hc;
  parameter logic [5:0] GPIO_DIRECT_OUT_OFFSET = 6'h10;
  parameter logic [5:0] GPIO_MASKED_OUT_LOWER_OFFSET = 6'h14;
  parameter logic [5:0] GPIO_MASKED_OUT_UPPER_OFFSET = 6'h18;
  parameter logic [5:0] GPIO_DIRECT_OE_OFFSET = 6'h1c;
  parameter logic [5:0] GPIO_MASKED_OE_LOWER_OFFSET = 6'h20;
  parameter logic [5:0] GPIO_MASKED_OE_UPPER_OFFSET = 6'h24;
  parameter logic [5:0] GPIO_INTR_CTRL_EN_RISING_OFFSET = 6'h28;
  parameter logic [5:0] GPIO_INTR_CTRL_EN_FALLING_OFFSET = 6'h2c;
  parameter logic [5:0] GPIO_INTR_CTRL_EN_LVLHIGH_OFFSET = 6'h30;
  parameter logic [5:0] GPIO_INTR_CTRL_EN_LVLLOW_OFFSET = 6'h34;
  parameter logic [5:0] GPIO_CTRL_EN_INPUT_FILTER_OFFSET = 6'h38;
