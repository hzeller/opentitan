...
package i2c_reg_pkg;
  ...
  typedef struct packed {
    ...
    struct packed {logic q;} tx_nonempty;
    struct packed {logic q;} tx_overflow;
    struct packed {logic q;} acq_overflow;
    struct packed {logic q;} ack_stop;
  ...
  typedef struct packed {
    struct packed {logic q;} enablehost;
    struct packed {logic q;} enabletarget;
  ...
  typedef struct packed {
    struct packed {logic [6:0] q;} address0;
    struct packed {logic [6:0] q;} mask0;
    struct packed {logic [6:0] q;} address1;
    struct packed {logic [6:0] q;} mask1;
  ...
  typedef struct packed {
    ...
    struct packed {logic d;} acqfull;
    struct packed {logic d;} txempty;
    struct packed {logic d;} acqempty;
  ...
  typedef struct packed {
    ...
    struct packed {logic [5:0] d;} acqlvl;
  ...
  typedef struct packed {
    struct packed {logic [7:0] d;} abyte;
    struct packed {logic [1:0] d;} signal;
  ...
  parameter logic [6:0] I2C_TARGET_ID_OFFSET = 7'h44;
  parameter logic [6:0] I2C_ACQDATA_OFFSET = 7'h48;
  parameter logic [6:0] I2C_TXDATA_OFFSET = 7'h4c;
