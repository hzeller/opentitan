...
module keymgr_reg_top (
  ...
  assign intr_state_op_done_wd = reg_wdata[0];
  ...
  assign intr_enable_op_done_wd = reg_wdata[0];
  ...
  assign intr_test_op_done_wd = reg_wdata[0];
  ...
  always_comb begin
    ...
    unique case (1'b1)
      addr_hit[0]: begin
        reg_rdata_next[0] = intr_state_op_done_qs;
        reg_rdata_next[1] = intr_state_err_qs;
      end

      addr_hit[1]: begin
        reg_rdata_next[0] = intr_enable_op_done_qs;
