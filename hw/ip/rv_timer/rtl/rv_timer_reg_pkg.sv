...
package rv_timer_reg_pkg;
  ...
  ////////////////////////////
  typedef struct packed {logic q;} rv_timer_reg2hw_ctrl_mreg_t;

  typedef struct packed {
    struct packed {logic [11:0] q;} prescale;
    struct packed {logic [7:0] q;} step;
  } rv_timer_reg2hw_cfg0_reg_t;

  typedef struct packed {logic [31:0] q;} rv_timer_reg2hw_timer_v_lower0_reg_t;

  typedef struct packed {logic [31:0] q;} rv_timer_reg2hw_timer_v_upper0_reg_t;
  ...
  typedef struct packed {logic q;} rv_timer_reg2hw_intr_enable0_mreg_t;

  typedef struct packed {logic q;} rv_timer_reg2hw_intr_state0_mreg_t;
  ...
  // Register Address
  parameter logic [8:0] RV_TIMER_CTRL_OFFSET = 9'h0;
  parameter logic [8:0] RV_TIMER_CFG0_OFFSET = 9'h100;
  parameter logic [8:0] RV_TIMER_TIMER_V_LOWER0_OFFSET = 9'h104;
  parameter logic [8:0] RV_TIMER_TIMER_V_UPPER0_OFFSET = 9'h108;
  parameter logic [8:0] RV_TIMER_COMPARE_LOWER0_0_OFFSET = 9'h10c;
  parameter logic [8:0] RV_TIMER_COMPARE_UPPER0_0_OFFSET = 9'h110;
  parameter logic [8:0] RV_TIMER_INTR_ENABLE0_OFFSET = 9'h114;
  parameter logic [8:0] RV_TIMER_INTR_STATE0_OFFSET = 9'h118;
  parameter logic [8:0] RV_TIMER_INTR_TEST0_OFFSET = 9'h11c;
